...
| --- | --- | --- | --- | --- |
| `docs/Artifacts/implementation_plan_005_0906.md` | 完了 | 2026-09-06 16:59 | 3次元カテゴリカル探索支援の改善・実装引継ぎ計画。OpenSpec change `validate-three-way-statistical-foundations` の初期引継ぎ設計。 | [`sources/implementation_plan_005_0906.md`](sources/implementation_plan_005_0906.md) |
| `docs/Artifacts/implementation_plan_006_0906.md` | 完了 | 2026-09-06 19:40 | 3次元探索支援の検証修正とスキル統合計画。正本エンジン配備、9モデルGLM適合、Dirichlet事後推定、代表実例検証の実行計画。 | [`sources/implementation_plan_006_0906.md`](sources/implementation_plan_006_0906.md) |
| `docs/Artifacts/implementation_plan_012_0911.md` | 完了 | 2026-09-11 06:35 | 5ブランチ整理と正式後継ブランチ策定計画。各ブランチの固有コミット・役割の保全監査とmain統合指針。 | [`sources/implementation_plan_012_0911.md`](sources/implementation_plan_012_0911.md) |
| `docs/Artifacts/implementation_plan_013_0912.md` | 完了 | 2026-09-12 02:02 / 04:24 | AG版・M版ダッシュボードの統合改善計画 (`standardize-three-way-dashboard`)。M1/M5基準セル診断、完全オフラインKaTeX/DataTables化、UCB標準版の設計。 | [`sources/implementation_plan_013_0912.md`](sources/implementation_plan_013_0912.md) |
| `docs/Artifacts/reference_docs_update_plan_001_0906.md` | 完了 | 2026-09-06 23:47 | 数理リファレンスと入口文書の更新計画。`docs/reference/` 配下の階層対数線形モデル・多項BIC等の体系化計画。 | [`sources/reference_docs_update_plan_001_0906.md`](sources/reference_docs_update_plan_001_0906.md) |
| `docs/Artifacts/semantic_governance_and_ranking_stability_plan_001_0907.md` | 完了 | 2026-09-07 00:08 | 現行3次元統計経路の意味論とセル順位安定性の整備計画。旧Evidence Scoreの監査列化、$\Delta G^2/N$ の定義正本化、スキル境界固定。 | [`sources/semantic_governance_and_ranking_stability_plan_001_0907.md`](sources/semantic_governance_and_ranking_stability_plan_001_0907.md) |
| `docs/Artifacts/statistical_validation_001_0906.md` | 完了 | 2026-09-06 23:31 | 3次元探索支援の実装・検証結果レポート。GLM対IPF照合、計98項目の契約・受入テスト完全通過の記録。 | [`sources/statistical_validation_001_0906.md`](sources/statistical_validation_001_0906.md) |
...
- **バッチマニフェスト**:
  - [`docs/Archives/archive_manifest.json`](archive_manifest.json)
