...
expected_a_sha256 <- digest::digest(file = input_a, algo = "sha256")
expected_b_sha256 <- digest::digest(file = input_b, algo = "sha256")
stopifnot(identical(result_a$inspection_contract_version, "2.0"))
stopifnot(grepl("^[0-9a-f]{64}$", result_a$input_sha256))
stopifnot(identical(result_a$input_sha256, expected_a_sha256))
stopifnot(identical(result_b$input_sha256, expected_b_sha256))
stopifnot(identical(result_a$file_sha256, result_a$input_sha256))
stopifnot(identical(result_b$file_sha256, result_b$input_sha256))
