...
run_dir <- file.path(repo_root, "output", "ucb_admissions", "run_ucb_admit_standa")
html_path <- file.path(run_dir, "dashboard.html")
band_html_path <- file.path(run_dir, "dashboard_band.html")
card_html_path <- file.path(run_dir, "dashboard_card.html")
