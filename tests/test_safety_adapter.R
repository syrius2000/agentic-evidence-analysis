...
cat("=== 1. Test MedDRA Metadata Provenance Requirement ===\n")
dummy_ae <- data.frame(
  subject_id = "SUBJ_1",
...
# - Bronchitis (1 occurrence)
# Both are in SOC "Infections".
# Patient 2 has:
# - Headache (1 occurrence) in SOC "Nervous"
...
cat("\n=== 3. Test Reciprocal RD (NNH / NNT) Management ===\n")
...
cat("\n=== 4. Test Zero-Cell Adverse Event Handling ===\n")
ae_zero <- data.frame(
  subject_id = "SUBJ_1",
