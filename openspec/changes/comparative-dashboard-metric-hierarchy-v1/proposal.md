...
- **非変更（契約分離）**:
  - `comparative_evidence.json` / `comparative-evidence-batch-v1`（nested `contrasts` = `comparative-evidence-v1`）は変更しない。
...
- **非影響**: `schemas/comparative-evidence-batch-v1.json`、`schemas/comparative-evidence-v1.json`、`comparative_contrasts.R`、`evidence_gower.R`、`evidence_feature_extract.R`
